...
import { makePremiumUser, removePremium } from "./features/premiumUser/premiumUserSlice";
    ...
    <div className="navbar bg-base-300 shadow-sm  ">
      ...
      {user && (
        <div className="flex gap-2 items-center">
          <div className="flex justify-center"><p className=" mr-2">Welcome, {user.firstName}</p>
          {isUserPremium ?  <img src={tick} style={{height: '25px'}} alt="logo"/>  : ""}
          </div>
